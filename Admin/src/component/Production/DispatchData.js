    ...
    const InputFieldComp = (props) => {
        ...
        return (<>
            ...
            <div className="">
                ...
                <input className="dueAmtValue" type="number" readOnly={true} value={props.inputvalue} onChange={(e) => { onChangeFun(e) }} />
            </div>
        </>)
    ...
    useEffect(() => {
        ...
        axios.get(url + "getStock").then((res) => {
            ...
            if (res.status === 200) {
                ...
                let datesArra = res.data[2].DailyProdDataArray[0].yearArray[0].monthArray[1].datesArray
                let Data = res.data
                ...
                console.log(selectedDate, selectedYear, selectedMonth, "thfggjjyhgtftjh");
                let inputvalue;
                let arr1 = []
                let dataArr1 = []
